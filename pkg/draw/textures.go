...
var textureMap = map[string]*textureDef{
	...
	"highlight":  &textureDef{`Interface\AddOns\groupauras\assets\alert_circle`, widget.BlendBlend, []float32{0, 1, 0, 1}},
	"radius":     &textureDef{`Interface\AddOns\groupauras\assets\radius`, widget.BlendBlend, []float32{0, 1, 0, 1}},
	"radius_lg":  &textureDef{`Interface\AddOns\groupauras\assets\radius_lg`, widget.BlendBlend, []float32{0, 1, 0, 1}},
	"timer":      &textureDef{`Interface\AddOns\groupauras\assets\timer`, widget.BlendBlend, []float32{0, 1, 0, 1}},
	...
	"tank":       &textureDef{`Interface\AddOns\groupauras\assets\roles`, widget.BlendBlend, []float32{0, 1, 0, 1}},
	"dps":        &textureDef{`Interface\AddOns\groupauras\assets\roles`, widget.BlendBlend, []float32{0, 1, 0, 1}},
	"healer":     &textureDef{`Interface\AddOns\groupauras\assets\roles`, widget.BlendBlend, []float32{0, 1, 0, 1}},
	"fadecircle": &textureDef{`Interface\AddOns\groupauras\assets\fadecircle`, widget.BlendBlend, []float32{0, 1, 0, 1}},
